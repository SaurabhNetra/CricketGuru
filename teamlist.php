      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="280" align="center" valign="top" class="bodytal">
               <table width="940" border="0" cellspacing="40" cellpadding="0">
                <tr>
                	<td width="220">&nbsp;</td>
                    ...
                    <td width="350" align="right" valign="top">  
                      ...
                      ?>
                        <tr align="right">
                            <td class="pqr" align="center">
                                <?php echo "<a href='teams.php?TeamName=".$row["Name"]."'>";?>
                                <img src="images/teams/<?php echo $row["Name"];?>.png"/ height="120" width="180" vspace="20" class="reflection">
                                <br>
                                <?php echo $row["Name"];?></a>
                            </td> 
                            <?php } ?>
