  ...
  <tr align="left" valign="top">
	...
	<table>
			...
			<?php echo $date[2]."/".$date[1]."/".$date[0]; ?>
	   		...
	   		<td>
			<img height="50%" width="50%" class="reflection" src="images/teams/<?php echo $row["Team1"];?>.png"/>
			</td>
			<td>
			<h3><strong>&nbsp;VS&nbsp;<strong><h3>
			</td>
			<td>
			<img height="50%" width="50%" class="reflection" src="images/teams/<?php echo $row["Team2"];?>.png"/>
			</td>
			</tr>
...
<?php if($i==1)
{?>
<tr><td><h3>No Record of Matches Scheduled in the near future</h3></td></tr>
<?php }?></table>
    </td>
            </tr>
            <tr height="40"></tr>
