...
$id=$_GET['Choice'];
$sql=mysql_query("Select * from schedule where Status=-1 and SID=$id");
...
<p><strong><?php echo $abbr1." ".$score1."/".$wickets1." Overs ".($balls1/6%1000).".".($balls1%6)." Extras ".$extras1;?></strong></p>  
<p><strong><?php echo $abbr2." ".$score2."/".$wickets2." Overs ".($balls2/6%1000).".".($balls2%6)." Extras ".$extras2;?></strong></p>
<p> <strong>Result : <?php echo $result;?> Win </strong></p>                    
					</td>
			</tr>
             <tr>
			<td height="40">&nbsp;</td>
			...
			<tr>
				<td align="center">
					<table width="700">
                    <tr><th align="center"><a href="javascript:showhide1()"><img src="images/inning1.png"></a></th></tr>
                    <div>
						<tr>
						<th align="left" id="inn11" style="display:none">Batting Scorecard</th>
						...
						<tr>
							...
							<th align="left">6s</th>
								...
								<?php
									...
									{?>
									<tr class="bcd"><td width="150"><?php echo $row["PlayerName"];?></td><td width="150"><?php if($row["BallOut"]==Null){echo "Not Out";}
									else
...
<?php $sqll=mysql_query("select * from livematch where MatchId=$matchid");
	$rowl=mysql_fetch_array($sqll);$over=$rowl["TeamABalls"];$rem=$over%6;$over=$over/6%1000;echo $over.".".$rem;?>
			...
			<tr>
			   <td align="center">
			      <table>	
                  <tr><th align="center"><a href="javascript:showhide2()" value="Inning 2"><img src="images/inning2.png"></a></th></tr>
				  <div>
				        <tr>
